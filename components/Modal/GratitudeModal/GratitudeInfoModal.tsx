      ...
      <View style={{ flex: 1, alignItems: "center", backgroundColor: "white" }}>
        <View style={{ width: "90%", flex: 1 }}>
          ...
          >
            ...
            <View className="h-fit w-full mt-[30px] flex items-center mb-[60]">
              <InfoModalContent
                text={
                  "대한 만족도를 높이는 효과적매일 세 가지 감사한 일을 적는 습관은 긍정적인 정서를 증진하고, 러한 실천은 긍정 심리학에서 자주 언급되며, 일상 속 작은 것들에 대한 감사의 마음을 인식하게 함으로써 우리의 정신적 건강에 긍정적인 영향을 미칩니다. 감사 일기를 작성하는 행위는 스트레스를 줄이고, 우울한 감정을 완화시키며, 전반적인 행복감을 증가시킬 수 있습니다. 또한, 감사를 통해 현재의 순간에 더 집중하게 되고, 인생에서 중요한 것들이 무엇인지에 대한 인식을 높이게 되어, 더 풍요로운 삶을 영위할 수 있는 기반을 마련하게 됩니다. 이와 같이 매일 세 가지 감사함을 기록하는 습관은 간단하지만 강력한 변화를 가져오는 도구로서, 일상의 소중함을 일깨우고 자기 자신과의 관계를 개선하는 데 큰 도움이 됩니다."
                }
              />
            </View>
          </KeyboardAwareScrollView>
